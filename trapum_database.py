...
class TrapumDataBase(BaseDBManager):
    ...
    def connect(self):
     ...
     #Before Observations
    def create_new_project(self,name,notes):
        """
    ...
    def create_new_beamformer_config(self,centre_freq,bw,nchans,tsamp,receiver,metadata):
        """
        ...
        values = ["'%f'"%centre_freq,"'%f'"%bw,"'%d'"%nchans,"'%f'"%tsamp,"%s"%receiver,"'%s'"%metadata]
        self.simple_insert("Beamformer_Configuration",cols,values)


    def create_new_target(self,project_id,source_name,ra,dec,region,semi_major_axis,semi_minor_axis,position_angle,metadata,notes):
        """
    ...
    # During Observations
    def create_new_pointing(self,target_id,bf_config_id,tobs,utc_start,sb_id,metadata,notes):
        """
    ...
    def create_new_beam(self,pointing_id,on_target,ra,dec,coherent):
        """
    ...
    def create_new_dataproduct(self,pointing_id,beam_id,processing_id,file_status,filepath,file_type,metadata,notes):
        """
    ...
    def create_new_processing(self,processing_id,pointing_id,pipeline_id,hardware_id,submit_time,start_time,end_time,process_status,metadata,notes):
        """
        ...
        cols = ["processing_id","pointing_id","pipeline_id","hardware_id","submit_time","start_time","end_time"
                ,"process_status","metadata","notes"]
        vals=["%d"%processing_id,"%d"%pointing_id,"%d"%pipeline_id,"%d"%hardware_id,"'%s'"%submit_time,"'%s'"%start_time,"'%s'"%end_time,
    ...
    def update_process_status(self,process_status):
        ...
        condition = "where pipeline running.."
        self.simple_update("Processings",cols,values,condition)


  
   # When pipeline starts
    def create_new_pipeline(self,HASH,name,notes):
        """
    ...
    def create_new_pivot(self,dp_id,processing_id):
        """
    ...
    def create_new_hardware_config(self,name,metadata,notes):
        """
